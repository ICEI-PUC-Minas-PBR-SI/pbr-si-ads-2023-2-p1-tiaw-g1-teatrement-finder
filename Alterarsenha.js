...
function alterarSenha() {
    ...
    const usuarioEncontrado = dadosJSON.usuarios_comuns.find(user => user.Email === email && user.Senha === senhaAtual);
    ...
    if (usuarioEncontrado && novaSenha === confirmarSenha) {
      ...
      alert('Não foi possível alterar a senha. Verifique suas credenciais e tente novamente.');
    }
  }
